    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "הדר רחמים תמם משרד עורכי דין HRT משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '0115b2e5-782a-473f-acb9-d008b21388bd',
                    name: data.name || '',
                    email: data.email || '',
